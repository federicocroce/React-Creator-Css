...
const UserReduxForm = props => {
    ...
    return (
        <form onSubmit={props.handleSubmit(submit.bind(this), props)}>
            <h1>Usuarios</h1>
            <InputText name='name' style='inline' placeholderFloating='Nombre' customPlaceholder='Ingrese su Nombre' type='text' validate={React.config.fieldValidations.validations.name} />
            ...
            <Button className='primary-button' label='Reset' onClick={() => props.setSelected()} />
